    ...
    def query_model_def(base_model_type, model_def):
        return {
            ...
            "custom_settings": [{
                ...
                "id": "qwen21_shift_terminal",
                "name": "Scheduler Terminal Shift",
                "label": "Scheduler Terminal Shift",
                "type": "dropdown",
                "default": "Base",
                "choices": [("Base (0.02)", "Base"), ("Disabled (Viggle Turbo)", "Disabled")],
                "info": "Use Base for the original 40-step model. Viggle Turbo's 4-step LoRA requires Disabled; its accelerator profile selects this automatically.",
            }, {
                "id": "rgba",
                "name": "RGBA",
                "label": "RGBA",
